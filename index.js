...
const branchA = new BankBranch({ name: "first Branch", address: "121 st Gerges Street" });
const branchB = new BankBranch({ name: "Second Branch", address: "2999 seshego dtreet" });

//    - Use the `getBranchInfo` method to retrieve branch information from the instances.
//    - Verify that `branchA` and `branchB` are both referring to the same instance by comparing them using `===`.
 console.log(branchA === branchB); // this will log true to the console
